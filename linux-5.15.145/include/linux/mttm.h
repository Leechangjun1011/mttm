...
#define WORKLOAD_TYPE_CLASSIFICATION_COOLING	3
//#define WORKLOAD_DRAM_DETERMINATION_COOLING	3
//#define MIN_CLASSIFICATION_THRESHOLD		((1UL << 28) / PAGE_SIZE)
//#define MAX_CLASSIFICATION_THRESHOLD		((1UL << 29) / PAGE_SIZE)
...
#define PEBS_STABLE_PERIOD	10007 //10000
#define PEBS_DRAM_DETER_PERIOD	997 //1000

#define MTTM_INIT_THRESHOLD	1
#define MTTM_DRAM_DETER_INIT_THRESHOLD	4
#define MTTM_THRES_COOLING_ALLOC	(256 * 1024 * 10) // 10GB
#define MTTM_INIT_COOLING_PERIOD	10000
#define MTTM_STABLE_COOLING_PERIOD	1000000
#define MTTM_WEAK_HOT_COOLING_PERIOD	2000000
//#define MTTM_DRAM_DETER_COOLING_PERIOD	10000
//#define MTTM_DRAM_DETER_COOLING_PERIOD_LIMIT	80000
#define MTTM_INIT_ADJUST_PERIOD		1000
#define MTTM_STABLE_ADJUST_PERIOD	20000
#define MTTM_WEAK_HOT_ADJUST_PERIOD	200000
