...
function run_mttm_sensitivity_mar_hi
{
	...
	mkdir -p ./evaluation/fig10/mttm
	./run_multi_tenants.sh $1 2>&1 | cat > ./evaluation/fig10/mttm/$1_$2_$3_$4.txt
	dmesg > ./evaluation/fig10/mttm/$1_$2_$3_$4_dmesg.txt
}
...
result_path=./evaluation/fig10/mttm

echo -e "### Same # of threads" > ./fig10_gups.dat
echo -e "alpha/beta = 0.5" >> ./fig10_gups.dat
cat ${result_path}/microbench-sensitivity1_24G_2_1.txt | grep GUPS >> ./fig10_gups.dat
echo -e "\nalpha/beta = 1" >> ./fig10_gups.dat
cat ${result_path}/microbench-sensitivity1_24G_1_1.txt | grep GUPS >> ./fig10_gups.dat
echo -e "\nalpha/beta = 2" >> ./fig10_gups.dat
cat ${result_path}/microbench-sensitivity1_24G_1_2.txt | grep GUPS >> ./fig10_gups.dat

echo -e "\n### Same hot set size" >> ./fig10_gups.dat
echo -e "alpha/beta = 0.5" >> ./fig10_gups.dat
cat ${result_path}/microbench-sensitivity2_24G_2_1.txt | grep GUPS >> ./fig10_gups.dat
echo -e "\nalpha/beta = 1" >> ./fig10_gups.dat
cat ${result_path}/microbench-sensitivity2_24G_1_1.txt | grep GUPS >> ./fig10_gups.dat
echo -e "\nalpha/beta = 2" >> ./fig10_gups.dat
cat ${result_path}/microbench-sensitivity2_24G_1_2.txt | grep GUPS >> ./fig10_gups.dat
