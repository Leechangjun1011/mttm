...
echo -e "PR:$pr MB ($pr_p %)" >> fig11.dat
echo -e "fotonik:$fotonik MB ($fotonik_p %)" >> fig11.dat
echo -e "Silo:$silo MB ($silo_p %)" >> fig11.dat
echo -e "$mttm_1_1_error\n" >> fig11.dat

echo -e "### MTTM 1:4" >> fig11.dat
...
echo -e "### Memstrata 1:1" >> fig11.dat
...
echo -e "### Memstrata 1:4" >> fig11.dat
