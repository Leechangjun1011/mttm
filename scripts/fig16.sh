...
function run_mttm_hugepage
{
	...
	mkdir -p ./evaluation/fig16/mttm/rxc/$1
	./run_multi_tenants.sh $1 2>&1 | cat > ./evaluation/fig16/mttm/rxc/$1/$2_$3.txt
	dmesg > ./evaluation/fig16/mttm/rxc/$1/$2_$3_dmesg.txt
}
...
function run_mttm_hugepage_norxc
{
	...
	mkdir -p ./evaluation/fig16/mttm/norxc/$1
	./run_multi_tenants.sh $1 2>&1 | cat > ./evaluation/fig16/mttm/norxc/$1/$2_$3.txt
	dmesg > ./evaluation/fig16/mttm/norxc/$1/$2_$3_dmesg.txt
}
