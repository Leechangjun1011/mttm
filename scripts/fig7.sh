...
function run_mttm_hugepage
{
        ...
        mkdir -p ./evaluation/fig7/mttm
        ./run_multi_tenants.sh $1 2>&1 | cat > ./evaluation/fig7/mttm/$1_$2_$3.txt
        dmesg > ./evaluation/fig7/mttm/$1_$2_$3_dmesg.txt
...
function run_local_hugepage
{
        ...
        mkdir -p ./evaluation/fig7/local
        ./run_multi_tenants_local.sh $1 2>&1 | cat > ./evaluation/fig7/local/$1.txt
        dmesg > ./evaluation/fig7/local/$1_dmesg.txt
...
set_160
run_mttm_hugepage microbench 24G 160
reset_latency
run_local_hugepage microbench

echo -e "time\tgups1\tgups2\tgups3\tgups_local" > fig7_gups.dat
line1=$(cat tot_gups_1_mttm.txt | wc -l)
line2=$(cat tot_gups_2_mttm.txt | wc -l)
line3=$(cat tot_gups_3_mttm.txt | wc -l)
...
echo 1 > fig7_time.txt
for i in $(seq 2 $max_line); do
	echo $i >> fig7_time.txt
done

paste fig7_time.txt tot_gups_1_mttm.txt tot_gups_2_mttm.txt tot_gups_3_mttm.txt tot_gups_1_local.txt >> fig7_gups.dat
